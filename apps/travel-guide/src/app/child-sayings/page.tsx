...
import { HandPointUpIcon, HeartIcon, SparklesIcon, BabyIcon } from '@/components/Icons';
        ...
        {token && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6">
            <textarea value={text} onChange={e => setText(e.target.value)}
              placeholder="孩子今天说了什么？"
              rows={2}
              className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-300 bg-white mb-3" />
