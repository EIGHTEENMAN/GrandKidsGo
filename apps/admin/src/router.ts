...
import GuideReports from './pages/GuideReports.vue'
...
const routes = [
  ...
  { path: '/travel/guide-reports', name: 'travel-guide-reports', component: GuideReports, meta: { title: '走天下攻略举报', requiresAuth: true } },
